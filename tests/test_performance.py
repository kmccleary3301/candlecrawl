...
def test_single_scrape_performance(client):
...
@pytest.mark.performance
def test_batch_scrape_small_performance(client):
...
@pytest.mark.performance
def test_batch_scrape_large_performance(client):
...
@pytest.mark.asyncio
@pytest.mark.performance
async def test_crawl_performance(client):
    start_time = time.time()
